...
const getDBConnectionString_1 = require("./getDBConnectionString"); // Adjust the path as necessary
describe('getDbConnectionString utility', () => {
    ...
    it('should return a connection string for MongoDB SRV with user and password', () => {
        ...
        const connectionString = (0, getDBConnectionString_1.getDbConnectionString)();
    ...
    it('should throw an error if required environment variables are missing', () => {
        expect(() => (0, getDBConnectionString_1.getDbConnectionString)()).toThrow('Database connection parameters are missing or incomplete.');
    });
...
//# sourceMappingURL=getDBConnectionString.test.js.map